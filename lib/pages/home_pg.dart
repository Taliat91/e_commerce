                        ...
                        // crossAxisAlignment: CrossAxisAlignment.,
                          children: [
                            ...
                            color: Colors.white
                             ...
                             Image.asset('assets/image/handbag.png',
                                height: 150,
                                width: 150,),
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                         ...
                         child: Text('50% OFF', style: TextStyle(fontSize: 16,
                         fontWeight: FontWeight.bold),
                        )
                       ),
                       ),
                      ...
                      GestureDetector(
                       onTap: () {
                         Navigator.push
                         (context, MaterialPageRoute(builder: (context) => ProductDisplayPage()),
                         );
                       }, 
                        child: Image.asset(myproducts[index].imagePath,
                        height: 80,
                        width: 80,
                        fit: BoxFit.cover,
                        ),
